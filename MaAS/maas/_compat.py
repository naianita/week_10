...
if sys.implementation.name == "cpython" and platform.system() == "Windows":
    ...
    if sys.version_info >= (3, 9, 0):
        try:
            ...
            # Semantic Kernel is optional and may not be compatible with the
            # installed pydantic / dependency versions. If it fails to import,
            # we simply skip the compatibility shim instead of crashing import.
            _ = None  # type: ignore
