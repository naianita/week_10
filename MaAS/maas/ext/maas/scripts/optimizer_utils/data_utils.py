...
class DataUtils:
    ...
    def create_result_data(
        ...
        """
        Create a result record for a training or test round.

        Older call sites only pass (round, score), so cost-related fields are
        optional and default to 0 when not provided. This keeps logging
        simple while avoiding TypeErrors.
        """
