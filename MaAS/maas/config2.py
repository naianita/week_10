...
try:
    # In many MaAS entrypoints (including our GSM8K runner) we provide LLMConfig
    # directly and do not require a global config file. Make this import
    # tolerant so missing/empty config2.yaml or env does not crash imports.
