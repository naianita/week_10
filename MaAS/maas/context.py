...
class Context(BaseModel):
    ...
    # Lazily loaded; many MaAS entrypoints (including our GSM8K runner) pass
    # LLMConfig explicitly and do not require a global config file.
    ...
    def llm(self) -> BaseLLM:
        ...
        if self.config is None:
            # Fallback to default config only when llm() is actually requested.
