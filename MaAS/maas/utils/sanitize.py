...
try:
    ...
    from tree_sitter import Language, Node, Parser  # type: ignore[import]
...
def sanitize(code: str, entrypoint: Optional[str] = None) -> str:
    ...
    """
    # If tree-sitter is not available, fall back to returning the longest
    # syntactically valid snippet without structural pruning.
    if tree_sitter_python is None or Parser is None or Language is None:  # type: ignore[truthy-function]
